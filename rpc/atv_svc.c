...
static void
mathop_1(struct svc_req *rqstp, register SVCXPRT *transp)
{
	union {
		operands soma_1_arg;
...
main (int argc, char **argv)
{
	...
	if (!svc_register(transp, MATHOP, MATHOP_1, mathop_1, IPPROTO_UDP)) {
		fprintf (stderr, "%s", "unable to register (MATHOP, MATHOP_1, udp).");
		exit(1);
	}
	...
	if (!svc_register(transp, MATHOP, MATHOP_1, mathop_1, IPPROTO_TCP)) {
		fprintf (stderr, "%s", "unable to register (MATHOP, MATHOP_1, tcp).");
		exit(1);
	}
